# Study Claw
Open index.html in a modern browser. No libraries, installation, or network connection required.
...
Redeem tickets for virtual prizes and view My collection. Progress stays in this browser when local storage is available. No real-world purchases or prizes.
...
Navigation has three tabs: Arcade Prizes (ticket shop), Claw Machine (game and tasks), and My Prizes (owned prizes with quantities). Tab changes preserve your active grab, mission, tickets, and collection. Arrow keys navigate focused tabs; game shortcuts apply only in the Claw Machine tab.

The claw roster includes bear, frog, unicorn, dog, cat, bunny, and chick plushies. The separate Arcade Prizes shop offers 41 virtual items: mints, gum, slime, keychains, lollipops, journals, gel pens, and a yo-yo. Shop art is a generated illustration atlas, not emojis or product photography. Previously collected items remain in My Prizes.

Brand references used for names and flavor context: https://www.hersheyland.com/ice-breakers , https://www.extragum.com/products/extra-polar-ice-sugar-free-chewing-gum-15-stick-single-pack-single , https://www.extragum.co.uk/our-products , https://toy.bandai.co.jp/en/article/detail/?cate=item&path=01_20400 . Shop ticket prices are fictional game values; slime colors are illustrated variants.

The top/bottom overlay has been removed. The control deck uses an isolated, flat stacking layer above the cabinet face to keep all arrow and grab buttons visible and clickable at narrow widths.

The expanded catalog includes fruity Ice Breakers and Extra varieties verified from official brand pages, plus glitter pens, four highlighter colors and a set, three correction-tape case colors, two scented glue sticks, cute rulers, and shaped erasers. Correction tape itself is white; only the dispenser color changes. Stationery is generic illustrated virtual merchandise.
